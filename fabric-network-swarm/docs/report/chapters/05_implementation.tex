...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ankit_dashboard.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ankit_workforce.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ankit_status.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ankit_audit.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ankit_inventory.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{images/mohit_pat_portal.png}
    \caption{Patient Portal: Self-Sovereign Health Record Access}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{images/mohit_pharm_portal.png}
    \caption{Pharmacist Portal: Prescription Fulfillment and Billing Interface}
    \label{fig:pharmacist_portal}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ronit_inv_portal1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ronit_inv_portal2.png}
